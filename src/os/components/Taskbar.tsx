        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button 
              ...
              className="p-1 rounded-md border bg-card hover:bg-secondary transition-all duration-150"
            >
              <BatteryFull className="h-4 w-4 text-primary" />
            </button>
          </TooltipTrigger>
          <TooltipContent side="top">This OS runs on 3 things: Hope, Heartbeats, and You</TooltipContent>
        </Tooltip>
        <button
          id="start-trigger"
